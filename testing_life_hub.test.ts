...
//Because of our problems with exporting functions from the mainfile, we have chosen to copy paste all functions
//needed for the tests

//Jest works in Node.js which have a problem with taking HTML Documents. Because of this we have chosen to change the the HTML 
//inputs to Parameters. Because of the problem with HTML, the local storage is not accessible either and we solved that by creating a
// local mock storage for hashtables and mock credentials.
